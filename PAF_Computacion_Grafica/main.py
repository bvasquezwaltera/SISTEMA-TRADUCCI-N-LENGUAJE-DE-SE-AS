            ...
            if len(results.multi_hand_landmarks):
                for num, hand_landmarks in enumerate(results.multi_hand_landmarks):
                    ...
                    if abs(thumb_tip[1] - index_finger_pip[1]) < 45 \
                            and abs(thumb_tip[1] - middle_finger_pip[1]) < 30 and abs(
                        thumb_tip[1] - ring_finger_pip[1]) < 30 \
                        ...
                        cv2.putText(image, 'A', (700, 150),
                            ...
                            middle_finger_pip[1] - middle_finger_tip[1] > 0 and ring_finger_pip[1] - ring_finger_tip[
                        1] > 0 and \
                            middle_finger_tip[1] - ring_finger_tip[1] < 0 and abs(
                        thumb_tip[1] - ring_finger_pip2[1]) < 40:
                        ...
                        cv2.putText(image, 'C', (700, 150),
                            ...
                            and pinky_pip[1] - pinky_tip[1] < 0 < index_finger_pip[1] - index_finger_tip[1]:
                        ...
                        cv2.putText(image, 'E', (700, 150),
                            ...
                            ring_finger_pip[1] - ring_finger_tip[1] > 0 and index_finger_pip[1] - index_finger_tip[
                        1] < 0 < abs(thumb_pip[1] - thumb_tip[1]) and distancia_euclidiana(index_finger_tip,
                                                                                           thumb_tip) < 65:
